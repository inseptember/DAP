...
# wandb.init(project="med_clip_dep_no_pt", entity="fengwei")
...
def main():
    ...
    #                             strict=False)
    if args.empty_pretrained:
        print('**************** Empty Pretrained Model *******************')
        model = RoFormerForSequenceCls(config, eos_token_id=tokenizer.convert_tokens_to_ids('[SEP]'))
    else:
    ...
    if args.with_tracking:
        ...
        accelerator.init_trackers("cls_200", experiment_config)
